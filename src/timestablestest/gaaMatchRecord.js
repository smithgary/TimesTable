/* 
 * Copyright Gary Smith, Sperringold.com
...
function removeTeamMember(){
        ...
        if (home){
            //alert("Going to remove player: " + homeTeam.team[playerIndex].name + "positioned " + playerIndex);
            //alert("Array Length = " + homeTeam.team.length);
            homeTeam.team.splice(playerIndex,1);
            //alert("Now that the removal is complete, length is: " + homeTeam.team.length);
            //homeTeam.team[playerIndex].name = a;
            //homeTeam.team[playerIndex].number = b;
        }else{
            //alert("Going to remove player: " + opposingTeam.team[playerIndex].name);
...
function countdown(endDate, throwIn) {
  ...
  function calculate() {
    ...
    if (timeRemaining >= 0) {
      ...
      document.getElementById("elapsedMinutes").innerHTML = ("0"  + eTminutesElapsed).slice(-2);
      document.getElementById("elapsedSeconds").innerHTML = ("0" + eTsecondsElapsed).slice(-2);
...
twitterHref += homeTeam.name + " " + homeTeam.goals + ":"  + homeTeam.points;
twitterHref += opposingTeam.name + " " + opposingTeam.goals + ":"  + opposingTeam.points;

//twitterHref += "Test from website - GS";
alert(twitterHref);
